...
%Dokumentangaben
\newcommand{\Titel}{Bachelor-Thesis}
\newcommand{\Uebertitel}{Smart Rehabilitation bei Kreuzbandrissen}
\newcommand{\AutorA}{Simon Grossenbacher}
\newcommand{\AutorB}{Reto Zurschmiede}
\newcommand{\DozentB}{Rolf Vetter}
\newcommand{\DozentA}{Ivo Oesch}
...
%
%Kapitel: Einleitung
\input{content/1_einleitung/einleitung}
%
%Kapitel: Grundlagen
\input{content/2_grundlagen/grundlagen}
%
%Kapitel: Konzept
\input{content/3_konzept/konzept}
%
%Kapitel: Implementierung
\input{content/4_implementierung/implementierung}
%
%Kapitel: Implementierung
\input{content/5_validierung/validierung}
%
%Kapitel: Schlussfolgerung
\input{content/6_schlusswort/schlusswort}
%
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Selbstaendigkeitserklärung
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{abstract/self}
%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter*{Quellen}
    In diesem Abschnitt sind alle Quellen des Dokumentes verzeichnet. Wird keine Referenz auf eine Quelle angegeben, so handelt es sich um selbst erarbeitete Inhalte der Autoren. Alle aus dem Internet stammenden Referenzen sind zusätzlich auf der beiliegenden CD abgelegt (siehe Anhang \vref{s:anhang_quellen_internet}).
    %
    %Literatur
...
%
%Anhang B
\input{appendix/aufgabenstellung/aufgabenstellung}
%
%Anhang C
\input{appendix/messung/messung}
%
%Anhang D
\input{appendix/cd/cd}
