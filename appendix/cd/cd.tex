...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\chapter{CD-ROM}\label{ch:cd}
	Aus ökologischen und ökonomischen Gründen wird ein grosser Teil des Anhangs in Form einer CD-ROM beigelegt. Die Dateistruktur entspricht dabei der Gliederung dieses Kapitels.
    %
