...
\section{LabVIEW auf NI myRIO} %\footnote{für detaillierte Erläuterungen zu den Projektphasen sei auf den Abschnitt \vref{ss:ablauf_gliederung_projekt} verwiesen}
	...
	\subsection{Hardware}\label{ss:myRIO_hw}
		...
		\end{itemize}
		%
		Die gesamte Hardware, inklusive Beschleunigungssensor ist in einem kompakten Gehäuse verbaut, wie die Abbildung \vref{img:myrio} zeigt. Die Befestigung kann auf einfache weise mithilfe von drei Schrauben erfolgen.
		%
		...
		\subsubsection*{Daten extrahieren}
			...
			\begin{description}
				...
				\begin{itemize}
					...
					\item Passwort: \textit{leer}
				\end{itemize}
				Daufhin präsentiert sich ein einfacher Dateiexplorer, wie ihn die Abbildung \vref{img:myrio_webdav} zeigt.
