...
\begin{figure}[htbp]
        ...
        \begin{subfigure}[htbp]{0.3\textwidth}
                ...
                \caption{Koordinatensystem myRIO 1900}
...
\section{Verifikation Translation}\label{s:verifikation_translation}
	...
	\subsection{Grund/Zweck der Messung}
		...
		\begin{hypo}\label{hypo:translation}	    	
			Nach einer linearen Translation um eine bestimmte Distanz \textit{x} misst das Konzept dieselbe. Die Abweichung ist dabei maximal \unit[1]{cm}. Die Position des \gls{g:myrio} hat keinen Einfluss auf das Messergebnis.
		\end{hypo}
	%
	%
	\subsection{Material/Testumgebung}\label{ss:material_translation}
		...
		%
		\subsubsection*{Translationsrichtung} \todo{umschreiben, Zeit erwähnen}
			Durch die Tatsache das der Kreuztisch M\low{1} über keine \acrshort{ac:cnc}-Steuerung verfügt, können keine konstante statischen Bewegungen in der X/Y-Ebene gefahren werden. Es wird deshalb auf ein Freiheitsgrad verzichtet und nur eine Translation in Y-Richtung vorgesehen. 
		%
	...
	\subsection{Methoden}
		...
		%
		\subsubsection*{Testbeschreibungen} \todo{erwartete gefahrenete Achse, Beschriftung Achse bei Bild}
			...
			\begin{itemize}
				\item \textbf{langsam} Die Translation ist nicht schneller als XXX\todo{Geschwindigkeit auf Wegzeit beziehen} in der Minute. Diese Vorgabe wird nur rudimentär mit einer Zeitmessung verifiziert.  
...
%			\end{itemize}
			...
			%
			\begin{itemize}
				\item Jede Messung ist 5 mal zu wiederholen (ergibt insgesamt 45 Messungen für dieses Protokoll)
				\item Die Bedienung des Kreuztisches muss durch unterschiedliche Personen erfolgen
				\item Die Translation beträgt immer \unit[100]{mm}
