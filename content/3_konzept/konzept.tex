...
Bei allen Messungen der drei verschiedenen Auslenkungen sind Abweichungen bezogen auf die Kontrollgruppe zu verbuchen. Die maximale Abweichung von \unit[-11.1]{m}, was einem Fehler von \unit[-22'233.5]{\%} entspricht, sind bei den Messungen der Auslenkung 3 zu verbuchen. Die Abweichungen in Auslenkung 1 und 2 sind zwar geringer als in Auslenkung 3, jedoch auch enorm gross (Auslenkung 1 \unit[-3.5]{m}, Auslenkung 2 \unit[-6.7]{m}).\par
%
...
%
Da bei der Auslenkung 3 die grösste Rotation bezogen auf die Drehung des Sensors durchgeführt wurde, sind bei diesen Messungen die Abweichungen am grössten. Die Erdbeschleunigung hat in diesem Fall den grössten Einfluss auf die Messungen. Somit werden die x- und y-Komponenten stärker verfälscht und dementsprechend ist auch die Integration fehlerbehafteter.
% 
Theoretisch gesehen sollte die Endposition von jeder Messung trotz Drift am selben Ort zustehen kommen. Dies setzt voraus, dass für jede Messung dieselbe Umlaufdauer besteht. Also über eine gleiche Zeitdauer integriert wird. Eine unrealistische Annahme, wenn man bedenkt dass der Rotationsarm von Hand gedreht wurde. Die Standartabweichung sagt aus diesem Grund wenig über die Messresultate als über die Konstanz der Drehdauer aus.\par
%
...
%
%Validierung
\section{Validierung}\todo{Auswertung Konzept}
