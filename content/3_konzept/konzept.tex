...
\section{Verifikation Translation}\label{s:verifikation_translation}
	...
	%
	%
	\subsection{Methoden}\label{ss:methode_tran}
		%
		\subsubsection*{Messgruppen}
...
%Validierung
\section{Validierung}
Die drei verschiedenen Verifikationen des Konzeptes haben gezeigt, dass das Konzept für den Anwendungsfall am Knie fehlerbehaftet ist. In diesem Fall kommen Bewegungen vor, welche zum einen einer Translation in der \gls{g:transversalebene} sowie einer Rotation entsprechen.\par 
%
