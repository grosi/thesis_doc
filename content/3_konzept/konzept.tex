...
Gemäss dem zuvor beschriebenem Testaufbau sollte eine Translation in negative und positive y-Richtung ersichtlich sein. Da der Startpunkt der Bewegung dem Endpunkt entspricht, sollte zum Schluss der Messung dieselbe Position  ersichtlich sein. Diese Position (y = \unit[0]{cm}) wird für die Fehlerbetrachtung als Referenz verwendet. Die gemessene Endposition wird zu dieser soll Endposition verglichen. In der Tabelle \vref{tab:auswertung_tran_rot} sowie den dargestellten Messungen zeigen alle drei Auslenkungen einen enormen Fehler auf. Dabei ist der Fehler der ersten Auslenkung geringer als der Fehler der zweiten Auslenkung. Der Fehler der zweiten Auslenkung jedoch geringer als der der dritten.
