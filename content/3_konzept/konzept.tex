...
\section{Angenäherter Bewegungsablauf}
...
%
% Blockdiagramm
\section{Blockdiagramm}\label{s:blockdiagramm}
...
%
% Verzögerung
\subsection{Berechnung der Bewegungsbeschleunigung}
...
\section{Verifikation Schätzung Rotationswinkel und Rotation}\label{s:verifikation_rotation}
	...
	\subsection{Grund/Zweck der Messung}
		...
		\begin{hypo}\label{hypo:rotation}	    	
			Nach einer einmaligen Rotation haben die Komponenten X und Y den Wert \unitfrac[0]{m}{s\high{2}} und die Z-Komponente \unitfrac[9.81]{m}{s\high{2}}. Die Abweichung ist dabei nicht grösser als \unitfrac[0.01]{m}{s\high{2}}. WINKEL NOCH ERWÄHNEN
		\end{hypo}
	%
	%
...
\section{Verifikation Translation}\label{s:verifikation_translation}
	...
	\subsection{Grund/Zweck der Messung}
		...
		\begin{hypo}\label{hypo:translation}	    	
			Nach einer linearen Translation um eine bestimmte Distanz \textit{x} misst das Konzept dieselbe. Die Abweichung ist dabei maximal \unit[5]{mm} betragen. Die Position des \gls{g:myrio} hat keinen Einfluss auf das Messergebnis haben.
		\end{hypo}
	%
	%
