...
\section{Vergleich Konzept - Implementierung}
	...
	\subsubsection*{Translation}
		Wiederum werden zwei Messungen in der z-Position durchgeführt. Zusätzlich zu der Kalibrationsphase wird nun noch eine Translation in der \gls{g:transversalebene} von \unit[5]{cm} in y-Richtung durchgeführt (Bewegungszeit \unit[1]{cm}). Erwartet wird ein zurückgelegter Weg von \unit[5]{cm} (mit einer Abweichung von $\pm$\unit[1]{cm}) in der gefahrenen Richtung.\par
		%
		Gemittelt über fünf Messungen ergibt das Konzept ein äquivalentes Resultat wie im Protokoll in Abschnitt XXX beschrieben. Die ermittelte Strecke beläuft sich auf \unit[4.31]{cm}. Die Implementierung dagegen liefert eine mittlere Distanz von \unit[255.2]{nm}. Dazu wird nach der Auslenkung die ursprüngliche Position angegeben. Die Richtung der Translation hingegen stimmt mit der Erwartung überein.\par
		%
		Die Analyse des ungenügenden Resultats konnte auf eine fehlerhafte Integration durch die \gls{ac:iir}-Filter zurückgeführt werden.