	...
	\subsection{Target}\label{ss:demo_target}
		...
		\subsubsection*{Frontpanel}
			...
			\begin{enumerate}
				...
				\item Die Schaltfläche \textsf{stop} dient zum Beenden der laufenden \gls{ac:vi}. Durch deren Betätigung wird ebenfalls, nachdem verstreichen eines Timeouts, die \gls{ac:vi} des \gls{g:host} abgebrochen (Netwerk-Stream Fehler). 
