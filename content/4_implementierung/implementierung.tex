...
\section{Vergleich Konzept - Implementierung}
	...
	\subsubsection*{Rotation, Translation überlagert}
		Wegen dem negative Resultat des Protokolls in Abschnitt \vref{s:verifikation_transaltion_rotation} und dem bekannten fehlerbehafteten Integrieren der Implementation	wird auf eine genauere Untersuchung dieses Testfalls verzichtet. Konzeptbedingt ist dazu kein aussagekräftiger Vergleich zu erwarten.
